---
layout: docs
title: "FrankenPHP | Créer un Build Statique"
nav: "Créer un Build Statique"
---
...
FrankenPHP prend également en charge [l'incorporation de l'application PHP dans le binaire statique](/fr/docs/embed/).
