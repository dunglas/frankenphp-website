---
layout: docs
title: "FrankenPHP | Compiler depuis les sources"
nav: "Compiler depuis les sources"
---
...
En alternative, il est aussi possible de [créer des builds statiques](/fr/docs/static/).
