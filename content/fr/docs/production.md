---
layout: docs
title: "FrankenPHP | Déploiement en Production"
nav: "Déploiement en Production"
---
...
Consultez "[Construire une image Docker personnalisée](/fr/docs/docker/)" pour plus de détails et d'options,
...
![Déployer FrankenPHP sur DigitalOcean avec Docker](/fr/docs/digitalocean-droplet.png)
...
![Configuring DNS on DigitalOcean](/docs/digitalocean-dns.png)
